...
class Datasource {
    ...
    private val latitude = 59.94229
    private val longitude = 10.71674
    private val metPath = "https://in2000-apiproxy.ifi.uio.no/weatherapi/locationforecast/2.0/compact.json?lat=$latitude&lon=$longitude"
    ...
    suspend fun fetchBeerJson(): List<Beer> {
        ...
        beerCache!!.forEach { Log.d("BEER API",it.name + " " + it.pictureURL)}
