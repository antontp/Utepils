...
class DrinkFilter {
    private val weatherToDrink: HashMap<String, List<String>> = hashMapOf(
        "SpringNice" to listOf("fruktig", "lett", "frisk"),
        "SpringSubpar" to listOf("fruktig", "fyldig", "søt", "tung"),
        "SummerNice" to listOf("lett", "fruktig", "søt", "frisk", "sur", "bitter", "salt"),
        "SummerSubpar" to listOf("lett", "fruktig", "søt", "frisk", "fyldig"),
        "AutumnNice" to listOf("fyldig", "sur", "bitter", "fruktig", "frisk"),
        "AutumnSubpar" to listOf("fyldig", "sur", "bitter", "krydret", "varm", "tung"),
        "WinterNice" to listOf("tung", "fyldig", "krydret", "varm", "bitter"),
        "WinterSubpar" to listOf("tung", "fyldig", "krydret", "varm", "søt"),
    )
